...
import { LayoutDashboard, Users, Briefcase, FileText, LogOut, Menu, X, MessageSquare } from "lucide-react"
...
export default function AdminLayout({
  ...
  const navItems = [
    ...
    { name: "Job Posts", href: "/admin/jobs", icon: <Briefcase className="h-5 w-5" /> },
    { name: "Blog Posts", href: "/admin/blogs", icon: <FileText className="h-5 w-5" /> },
    {
    ...
    <div className="flex h-screen bg-gray-100 overflow-hidden">
      ...
      >
        ...
        <div className="p-6 border-b shrink-0 hidden lg:block">
          <Link href="/admin" className={cn("text-3xl font-bold gradient-text", !isSidebarOpen && "lg:hidden")}>
            DataArch Admin
          </Link>
          {!isSidebarOpen && (
        ...
        <nav className="p-4 flex flex-col flex-grow overflow-y-auto">
              ...
              <li key={item.name}>
                <Link
                  ...
                  className={cn(
                    ...
                    isActive(item.href) ? "bg-purple-dark text-white" : "text-gray-700 hover:bg-gray-100",
                  )}
                >
          ...
          <div className="mt-auto pt-4 border-t">
            ...
            >
              ...
              <span className={cn(!isSidebarOpen && "lg:hidden")}>{isLoggingOut ? "Logging out..." : "Logout"}</span>
            </button>
          </div>
        </nav>
      </aside>
