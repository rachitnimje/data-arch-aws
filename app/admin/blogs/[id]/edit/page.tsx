  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description:
          "There was an error updating the blog post. Please try again.",
        variant: "destructive",
      });
    } finally {
      setIsSubmitting(false);
      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="title" className="block text-m font-medium mb-1">
            ...
            <div>
              <label htmlFor="tags" className="block text-m font-medium mb-1">
                Tags
              </label>
              <Input
                id="tags"
            ...
            {originalBlog && (
              <div className="text-xs text-gray-500">
                Last updated:{" "}
                {new Date(originalBlog.updated_at).toLocaleString()}
              </div>
            )}
